...
So if you are interested in embedding Elm in something else, do the same trick! You can get more complete docs on embedding Elm in HTML [here](https://guide.elm-lang.org/interop/javascript.html#step-1-embed-in-html) and JavaScript interop [here](https://guide.elm-lang.org/interop/javascript.html#step-2-talk-to-javascript). Let the community know if you make something!
